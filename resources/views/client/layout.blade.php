...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Oganic, Food, Thực phẩm">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="../../../public/site/img/logo.png" alt=""></a>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li class="{{ request()->is('sanpham') ? "active" : "" }}"><a href="{{ route('sanpham') }}">Cửa hàng</a></li>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> support@organic.vn</li>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="{{ request()->is('sanpham') ? 'active' : '' }}"><a href="{{route('sanpham')}}">Sản phẩm</a></li>
